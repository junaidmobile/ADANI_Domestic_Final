...
function beforeCompleteAcceptance() {
    if (
        confirm(
            "Are you sure you want to complete screening? This action cannot be revoked."
        )
    ) {
        SaveCompleteDetails();
    } else { }
            ...
            success: function (Result) {
                ...
                $(xmlDoc)
                    ...
                    .each(function (index) {
                        ...
                        scalDetailTableForAcceptance(RowId, NOP, WEIGHT, Length, Width, Height, Volume);
...
var _selectIndex = 0
function scalDetailTableForAcceptance(RowId, NOP, WEIGHT, Length, Width, Height, Volume) {
    ...
    html += "<td style='padding: 2px;' align='right'><input id='' class='form-control' type='text' value='" + NOP + "' disabled='disabled'></td>";
    html += "<td style='padding: 2px;' align='right'><input id='' class='form-control' type='text' value='" + WEIGHT + "' disabled='disabled'></td>";
    html += "<td style='padding: 2px;' align='right'><input id='' class='form-control' type='text' value='" + Length + "' disabled='disabled'></td>";
    html += "<td style='padding: 2px;' align='right'><input id='' class='form-control' type='text' value='" + Width + "' disabled='disabled'></td>";
    html += "<td style='padding: 2px;' align='right'><input id='' class='form-control' type='text' value='" + Height + "' disabled='disabled'></td>";
    html += "<td style='padding: 2px;' align='right'><input id='' class='form-control' type='text' value='" + Volume + "' disabled='disabled'></td>";


    html += "<td style='padding: 2px;' align='right'> <select class='form-control pnlTextBox' id='ddlAccCMINDynamic" + _selectIndex + "' disabled='disabled'>></select></td>";
    ...
    //     var newOption = $("<option></option>");
    //     newOption.val(Value).text(Text);
    //     newOption.appendTo("#ddlAccCMINDynamic");
    // });
